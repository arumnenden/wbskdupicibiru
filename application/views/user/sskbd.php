                    ...
                    <div class="card-header">
                        ...
                        <?php if ($user['activated'] == 0) : ?>
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add-pindah">
                                <i class="fas fa-plus-circle"></i> Tambah Permohonan Surat Keterangan Bersih Diri
                            </button>
                        <?php else : ?>
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class=" table table-bordered table-hover" id="table-id" style="font-size:14px;">
                                <thead>
                                    ...
                                    <th>Tanggapan</th>
                                    <th>Status</th>
                                    <th>Surat Keterangan Bersih Diri</th>
                                    <th>Hapus</th>
                                </thead>
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($list_sskbd as $lsp) : ?>
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            ...
                                            <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_sskbd']; ?>" data-toggle="modal" data-target="#liatimage"><i class="fas fa-eye"></i>Lihat</<button>
                                            <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_sskbd']; ?>" data-toggle="modal" data-target="#liatfile2"><i class="fas fa-eye"></i>Lihat</<button>
                                            <!-- <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_sskbd']; ?>" data-toggle="modal" data-target="#liatfile3"><i class="fas fa-eye"></i>Lihat</<button>    -->
                                            ...
                                            <?php endif; ?>
                                            <?php if ($lsp['status_sskbd'] == 0) : ?>
                                                <td><button type="button" class="tombol-edit btn btn-success btn-block btn-sm" data-id="<?php echo $lsp['id_sskbd']; ?>" data-toggle="modal" data-target="#liatfilebalas"><i class="fas fa-eye"></i>Lihat</<button>
                                                </td>
                                            <?php else : ?>
                                                <td>
                                                    <button type="button" class="tombol-edit btn btn-danger btn-block btn-sm" data-id="<?php echo $lsp['id_sskbd']; ?>" data-toggle="modal" data-target="#"><i class="fas fa-eye"></i>Lihat</<button>
                                                </td>
                                            <?php endif; ?>
                                            <?php if ($lsp['status_sskbd'] == 1) : ?>
                                                <td><a href="<?php echo base_url('user/del_sskbd/') . $lsp['id_sskbd']; ?>" class="tombol-hapus btn btn-danger btn-block btn-sm"><i class="fas fa-trash-alt"></i> Hapus</a> </td>
                                            <?php else : ?>
                                                <td>
...
<div class="modal fade" id="add-pindah">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart('user/add_sskbd'); ?>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <input type="hidden" class="form-control form-control-sm" name="date_sskbd" value="<?php echo date('d/m/y'); ?>">
                        </div>
...
<div class="modal fade" id="edit-komp">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart('user/edit_sskbd'); ?>
                    <input type="hidden" name="id_sskbd" id="idjson">
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control form-control-sm" name="date_sskbd" id="tgl" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<div class="modal fade" id="liatfilebalas">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Surat Keterangan Bersih Diri</h4>
            </div>
            <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart('admin/edit_komplain'); ?>
...
<script>
    $('.tombol-edit').on('click', function() {
        const id_sskbd = $(this).data('id');
        $.ajax({
            url: '<?php echo base_url('user/get_edit_sskbd'); ?>',
            data: {
                id_sskbd: id_sskbd
            },
            method: 'post',
            ...
            success: function(data) {
                ...
                $('#tgl').val(data.date_sskbd);
                $('#idjson').val(data.id_sskbd);
            }
        });
    });
</script>