                    ...
                    <div class="card-header">
                        ...
                        <?php if ($user['activated'] == 0) : ?>
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add-pindah">
                                <i class="fas fa-plus-circle"></i> Tambah Permohonan Surat Pengaduan
                            </button>
                        <?php else : ?>
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class=" table table-bordered table-hover" id="table-id" style="font-size:14px;">
                                <thead>
                                    ...
                                    <th>Tanggapan</th>
                                    <th>Status</th>
                                    <th>Surat Tanggapan Pengaduan</th>
                                    <th>Hapus</th>
                                </thead>
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($list_ssdispensasi as $lsp) : ?>
                                        <tr>
                                            ...
                                            <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_ssdispensasi']; ?>" data-toggle="modal" data-target="#liatimage"><i class="fas fa-eye"></i>Lihat</<button>
                                            <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_ssdispensasi']; ?>" data-toggle="modal" data-target="#liatfile2"><i class="fas fa-eye"></i>Lihat</<button>
                                            <!-- <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_ssdispensasi']; ?>" data-toggle="modal" data-target="#liatfile3"><i class="fas fa-eye"></i>Lihat</<button>    -->
                                            ...
                                            <?php endif; ?>
                                            <?php if ($lsp['status_ssdispensasi'] == 0) : ?>
                                                <td><button type="button" class="tombol-edit btn btn-success btn-block btn-sm" data-id="<?php echo $lsp['id_ssdispensasi']; ?>" data-toggle="modal" data-target="#liatfilebalas"><i class="fas fa-eye"></i>Lihat</<button>
                                                </td>
                                            <?php else : ?>
                                                <td>
                                                    <button type="button" class="tombol-edit btn btn-danger btn-block btn-sm" data-id="<?php echo $lsp['id_ssdispensasi']; ?>" data-toggle="modal" data-target="#"><i class="fas fa-eye"></i>Lihat</<button>
                                                </td>
                                            <?php endif; ?>
                                            <?php if ($lsp['status_ssdispensasi'] == 1) : ?>
                                                <td><a href="<?php echo base_url('user/del_ssdispensasi/') . $lsp['id_ssdispensasi']; ?>" class="tombol-hapus btn btn-danger btn-block btn-sm"><i class="fas fa-trash-alt"></i> Hapus</a> </td>
                                            <?php else : ?>
                                                <td>
...
<div class="modal fade" id="add-pindah">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart('user/add_ssdispensasi'); ?>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <input type="hidden" class="form-control form-control-sm" name="date_ssdispensasi" value="<?php echo date('d/m/y'); ?>">
                        </div>
                        
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Upload KTP/KTM</label>
                                <input type="file" class="form-control-file" name="image">
                            </div>
                        
                        
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Upload Surat Pengaduan</label>
                        ...
                        <span class="text-muted" style="font-size:12px;">* Format gambar JPG, JPEG, PNG, PDF dan ukuran gambar kurang dari 5 MB</span>
                        <hr>
                    </div>
...
<div class="modal fade" id="edit-komp">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart('user/edit_ssdispensasi'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control form-control-sm" name="date_ssdispensasi" id="tgl" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <div class="box-body">
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <object data="<?php echo base_url('assets/images/' . $lsp['file2']); ?>" class="img-thumbnail min-vh-100" alt="User Image" style="width:100%;"></object><br>
                        </div>
                    </div>
...
<div class="modal fade" id="liatfilebalas">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Surat Pindah</h4>
            </div>
            <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart('admin/edit_komplain'); ?>
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <object data="<?php echo base_url('assets/images/' . $lsp['filebalas']); ?>" class="img-thumbnail min-vh-100" alt="User Image" style="width:100%;" id="image"></object><br>
                        </div>
                    </div>
...
<script>
    $('.tombol-edit').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo base_url('user/get_edit_ssdispensasi'); ?>',
            data: {
