                    ...
                    <div class="card-header">
                        ...
                        <?php if ($user['activated'] == 0) : ?>
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add-pindah">
                                <i class="fas fa-plus-circle"></i> Tambah data Pengaduan
                            </button>
                        <?php else : ?>
                        <?php endif; ?>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($list_ssktp as $lsp) : ?>
                                        <tr>
                                            ...
                                            <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_ssktp']; ?>" data-toggle="modal" data-target="#liatimage"><i class="fas fa-eye"></i>Lihat</<button>
                                            <!-- <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_ssktp']; ?>" data-toggle="modal" data-target="#liatfile2"><i class="fas fa-eye"></i>Lihat</<button> -->
                                            <!-- <td><button type="button" class="tombol-edit btn btn-primary btn-block btn-sm" data-id="<?php echo $lsp['id_ssktp']; ?>" data-toggle="modal" data-target="#liatfile3"><i class="fas fa-eye"></i>Lihat</<button>    -->
                                            ...
                                            <?php endif; ?>
                                            <?php if ($lsp['status_ssktp'] == 0) : ?>
                                                <td><button type="button" class="tombol-edit btn btn-success btn-block btn-sm" data-id="<?php echo $lsp['id_ssktp']; ?>" data-toggle="modal" data-target="#liatfilebalas"><i class="fas fa-eye"></i>Lihat</<button>
                                                </td>
                                            <?php else : ?>
                                                <td>
                                                    <button type="button" class="tombol-edit btn btn-danger btn-block btn-sm" data-id="<?php echo $lsp['id_ssktp']; ?>" data-toggle="modal" data-target="#"><i class="fas fa-eye"></i>Lihat</<button>
                                                </td>
                                            <?php endif; ?>
                                            <?php if ($lsp['status_ssktp'] == 1) : ?>
                                                <td><a href="<?php echo base_url('user/del_ssktp/') . $lsp['id_ssktp']; ?>" class="tombol-hapus btn btn-danger btn-block btn-sm"><i class="fas fa-trash-alt"></i> Hapus</a> </td>
                                            <?php else : ?>
                                                <td>
...
<div class="modal fade" id="add-pindah">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart('user/add_ssktp'); ?>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <input type="hidden" class="form-control form-control-sm" name="date_ssktp" value="<?php echo date('d/m/y'); ?>">
                        </div>
                        
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Upload Kartu Keluarga</label>
                                <input type="file" class="form-control-file" name="image">
                            </div>
                        
                        
                            <!-- <div class="form-group">
                                <label for="exampleFormControlFile1">Upload Surat Pengantar Dari Desa</label>
...
<div class="modal fade" id="edit-komp">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart('user/edit_ssktp'); ?>
                    <input type="hidden" name="id_ssktp" id="idjson">
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control form-control-sm" name="date_ssktp" id="tgl" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="nama">Kartu Keluarga</label>
...
<script>
    $('.tombol-edit').on('click', function() {
        const id_ssktp = $(this).data('id');
        $.ajax({
            url: '<?php echo base_url('user/get_edit_ssktp'); ?>',
            data: {
                id_ssktp: id_ssktp
            },
            method: 'post',
            ...
            success: function(data) {
                ...
                $('#tgl').val(data.date_ssktp);
                $('#idjson').val(data.id_ssktp);
            }
        });
    });
</script>