    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                ...
                <div class="card">
                    <div class="card-body">
                        <?php echo form_open_multipart('admin/pkk'); ?>
                        <div class="form-group">
                            <label>Tanggal</label>
                            <input type="date" class="form-control col-md-2" name="tgl_pkk" required>
                        </div>
                        <div class="form-group">
                            <label>Penulis</label>
                            <input type="text" class="form-control" name="penulis_pkk" value="<?php echo $user['nama']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label>Judul Data</label>
                            <input type="text" class="form-control" name="judul_pkk" required>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <textarea class="summernote" name="pkk" required></textarea>
                        </div> -->
                        <div class="form-group">
