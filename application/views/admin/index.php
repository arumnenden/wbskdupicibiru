            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <button type="button" class="btn btn-outline-primary btn-sm mr-1" data-toggle="modal" data-target="#ubah-profile"><i class="fas fa-user-edit"></i> Ubah Profile</button>
                        <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#ubah-pass"><i class="fas fa-key"></i> Ubah Password</button>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
